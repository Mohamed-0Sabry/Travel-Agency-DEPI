...
const AdminDashboard = () => {
  ...
  const handleDeleteFlight = async (flightId) => {
    if (window.confirm('Are you sure you want to delete this flight?')) {
      try {
        // Use the API client directly to delete from DB
        await apiClient.flights.delete(flightId);
  ...
  const handleDeleteHotel = async (hotelId) => {
    if (window.confirm('Are you sure you want to delete this hotel?')) {
      try {
        // Use the API client directly to delete from DB
        await apiClient.hotels.deleteHotel(hotelId);
        // Then refresh the hotels list
        await getHotels();
  ...
  // Refresh handlers for after adding new items
